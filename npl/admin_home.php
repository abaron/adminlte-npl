        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Arhubel Binus</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> Approved NPL</li>
            </ul>
          ...
          <div class="box box-solid bg-teal-gradient">
            <div class="box-header">
              ...
              <h3 class="box-title">NPL Stats</h3>
            ...
            <div class="box-footer no-border">
              <div class="row">
                <div class="col-xs-3 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">Bekasi Utara</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-3 text-center" style="border-right: 1px solid #f4f4f4">
                  <div id="sparkline-2"></div>
                  <div class="knob-label">Bekasi Selatan</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-3 text-center">
                  <div id="sparkline-3"></div>
                  <div class="knob-label">Bekasi Timur</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-3 text-center">
                  <div id="sparkline-4"></div>
                  <div class="knob-label">Bekasi Barat</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
            ...
            <div class="box-footer text-black">
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="progress xs">
                    <div class="progress-bar progress-bar-blue" style="width: 3%;"></div>
                  </div>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                  ...
                  <div class="progress xs">
                    <div class="progress-bar progress-bar-red" style="width: 6%;"></div>
                  </div>

                  <div class="clearfix">
                    <span class="pull-left">Draft</span>
